...
def initial_tables():
	db.session.add_all([ \
		...
		User(name=u'张剑锋', email=u'zhangjianfeng@tvmining.com', qq='100000', mobile='1300000001', password='123456', team_id=2, active=1),
		...
		User(name=u'王锡武', email=u'wangxiwu@tvmining.com', qq='600000', mobile='1300000006', password='123456', team_id=2, active=1),
		...
		User(name=u'樊占涛', email=u'fanzhantao@tvmining.com', qq='1300000', mobile='1300000013', password='123456', team_id=1, active=0),
